...
class TestGetOpenaiEmbeddings:
    ...
    def test_batching_over_100(self, mock_openai_client):
        ...
        mock_openai_client.embeddings.create.side_effect = lambda **kwargs: make_response(kwargs["input"])
...
class TestGetLocalEmbeddings:
    def test_returns_embeddings(self):
        ...
        with patch("embed.SentenceTransformer", return_value=mock_model) if hasattr(__import__("embed"), "SentenceTransformer") else \
...
class TestRunEmbeddings:
    ...
    def test_successful_embedding(self):
        ...
        with patch("embed.get_db_connection", return_value=mock_conn), \
            ...
            with patch("embed.get_openai_embeddings", return_value=embeddings), \
