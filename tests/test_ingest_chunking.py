...
from ingest import chunk_text_with_headings, count_tokens
...
class TestChunkTextWithHeadings:
    ...
    def test_text_exceeding_max_tokens_splits(self):
        ...
        paragraphs = [f"Paragraph {i} with some extra words to pad it out." for i in range(30)]
        long_text = "\n".join(paragraphs)
    ...
    def test_document_title_prefix(self):
        ...
        chunks = chunk_text_with_headings(pages, max_tokens=500, document_title="My Document")
    ...
    def test_new_level1_resets_path(self):
        ...
        second_chapter_chunks = [c for c in chunks if "Second Chapter" in c["headings_path"]]
